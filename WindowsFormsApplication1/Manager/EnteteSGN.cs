...
namespace HarmonizedApp.Manager
{
    class EnteteSGN
    {
        ...
        public Worksheet EnteteSVRLigne11A015(Worksheet worksheet)
        {
            ...
            worksheet.Cells[10, 3] = new Cell("Date d'embauche société");
            worksheet.Cells[10, 4] = new Cell("Date de départ société");
            worksheet.Cells[10, 5] = new Cell("Code département");
            worksheet.Cells[10, 6] = new Cell("Intitulé département");
            worksheet.Cells[10, 7] = new Cell("Nature du contrat");
            worksheet.Cells[10, 8] = new Cell("Emploi occupé");
            worksheet.Cells[10, 9] = new Cell("Salaire de base annuel");
            worksheet.Cells[10, 10] = new Cell("Salaire de base Mensuel");
            worksheet.Cells[10, 11] = new Cell("Présence");
            worksheet.Cells[10, 12] = new Cell("Salaire de base jours travaillés");
            worksheet.Cells[10, 13] = new Cell("Prime de Panier");
            worksheet.Cells[10, 14] = new Cell("Prime de Transport");
            worksheet.Cells[10, 15] = new Cell("Prime de peréquation");
            worksheet.Cells[10, 16] = new Cell("Prime exeptionnelle");
            worksheet.Cells[10, 17] = new Cell("Bonus");
            worksheet.Cells[10, 18] = new Cell("Lump-sum");
            worksheet.Cells[10, 19] = new Cell("Gym Allowance");
            worksheet.Cells[10, 20] = new Cell("Prime de naissance");
            worksheet.Cells[10, 21] = new Cell("Prime aid idha");
            worksheet.Cells[10, 22] = new Cell("Prime aid fitr");
            worksheet.Cells[10, 23] = new Cell("Spot Bonus");
            worksheet.Cells[10, 24] = new Cell("Congés à payer");
            worksheet.Cells[10, 25] = new Cell("Rappel");
            worksheet.Cells[10, 26] = new Cell("Avantage en nature voiture fonction");
            worksheet.Cells[10, 27] = new Cell("Avantage en nature essence");
            worksheet.Cells[10, 28] = new Cell("Avantage en nature logement");
            worksheet.Cells[10, 29] = new Cell("Total Brut");
            worksheet.Cells[10, 30] = new Cell("CNSS");
            worksheet.Cells[10, 31] = new Cell("CNSS Complémentaire");
            worksheet.Cells[10, 32] = new Cell("Salaire Imposable");
            worksheet.Cells[10, 33] = new Cell("IRPP");
            worksheet.Cells[10, 34] = new Cell("Redevance");
            worksheet.Cells[10, 35] = new Cell("Remboursement");
            worksheet.Cells[10, 36] = new Cell("Avantage voiture");
            worksheet.Cells[10, 37] = new Cell("Retenue Assurance groupe");
            worksheet.Cells[10, 38] = new Cell("Total Déduction employé");
            worksheet.Cells[10, 39] = new Cell("Net à Payer");
            worksheet.Cells[10, 40] = new Cell("CNSS Employeur");
            worksheet.Cells[10, 41] = new Cell("CNSS Complémentaire");
            worksheet.Cells[10, 42] = new Cell("Accident de travail");
            worksheet.Cells[10, 43] = new Cell("Total Contribution Employeur");
            worksheet.Cells[10, 44] = new Cell("Mois de paie");
