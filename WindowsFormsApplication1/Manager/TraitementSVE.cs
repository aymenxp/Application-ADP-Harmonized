...
namespace HarmonizedApp.Manager
{
    class TraitementSVE
    {
        ...
        Entete_SVE entete = new Entete_SVE();


        public void ExtraireDataSVE(string Date1, string Date2, string CodeSoc, string NomSoc, ProgressBar prog, int idSoc, int MoisPe, int anneePe)
        {
            ...
            saveFileDialog1.FileName = "P_SVE_" + CodeSoc + "_" + Date1 + "_" + Date2 + "_00_V2_0000_00000_FILE_NOE_" + NomSoc + "Variancereportperemployee.xls";
